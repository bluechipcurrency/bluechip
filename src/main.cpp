...
int64 nChainStartTime = 1402462373;
...
const string strMessageMagic = "BlueChip Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
        nSubsidy = 150000 * COIN; // 1% for the stripper fund
    else if(nHeight > 1 && nHeight <= 100)
	nSubsidy = 1 * COIN; 
    else if(nHeight > 100 && nHeight <= 3100)
	nSubsidy = 2000 * COIN;
    else if(nHeight > 3100 && nHeight <= 8100)
	nSubsidy = 1000 * COIN;
    else if(nHeight > 8100 && nHeight <= 10100)
	nSubsidy = 2000 * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BlueChip
    bool fStrictPayToScriptHash = true; // Always active in BlueChip
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BlueChip", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "22 March 2014 - Bloomberg - Bugatti-Driving 26-Year-Old Tied to Penny-Stock Website";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x649f8424109361dce9747dac1ef55b65f96e21147d5e002c68073482a7e25b24"));
